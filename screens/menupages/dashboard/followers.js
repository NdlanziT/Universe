    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.group6} >
                        ...
                        <Text style={styles.text}>Overview followers</Text>
            </View>
            <Text style={styles.reachedaudience}>Follower stats</Text>
            ...
            <View style={styles.group4}>
                <View style={styles.details}>
                    <Text style={styles.toolsheadings}>Followers Activity</Text>
